...
kmean_sub <- kml3d::cld3d(
  ...
  timeInData = list(
    Frontal_L = c(2, 26, 14),
    Parietal_L = c(4, 28, 16),
    Temproal_L = c(6, 30, 18),
    Occipital_L = c(10, 34, 22),
    Frontal_R = c(3, 27, 15),
    Parietal_R = c(5, 29, 17),
    Temproal_R = c(7, 31, 19),
    Occipital_R = c(11, 35, 23)
  ),
...
perc_sub <- paste0(
  round(
    100 * table(sub_clusters_kmeans) / length(unique(brain_vol_prop_wide$subj_id)),
    1
  ),
  "%"
)
...
dat_sub <- data.frame(
  subj_id = brain_vol_prop_wide$subj_id,
